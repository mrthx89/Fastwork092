...
DefaultGroupName={#MyGroupApp}\EM4
OutputBaseFilename=EM4_SETUP
...
Source: "..\EM4.App\bin\Debug\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\EM4.App\bin\Debug\*.dll"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: "..\EM4.App\bin\Debug\*.exe"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\EM4.App\bin\Debug\*.config"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
